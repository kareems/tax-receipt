...
// (which is specified in many of the fields for the source data), and optionally its own
// `activites` array for any subdepartments. This nesting can go arbitrarily deep. If
